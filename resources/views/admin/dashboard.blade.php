...
@section('content')
    <div class="mb-6">
        <h2 class="text-2xl sm:text-3xl font-bold text-gray-800">Welcome, {{ Auth::guard('admin')->user()->name }}!</h2>
        <p class="text-gray-600 mt-2 text-sm sm:text-base">Here's an overview of your system.</p>
    </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-800 mt-2">{{ $stats['form_submissions'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-800 mt-2">{{ $stats['admins'] ?? 0 }}</p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl sm:text-3xl font-bold text-gray-800 mt-2">{{ $stats['users'] ?? 0 }}</p>
                </div>
