...
@section('content')
    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6">
        <div class="mb-6">
            <a href="{{ route('admin.form_submissions.index') }}" class="text-blue-600 hover:text-blue-800 inline-block">
                ← Back to List
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div>
                ...
                <p class="text-base sm:text-lg text-gray-900">{{ $submission->id }}</p>
            </div>
        ...
        <div class="mt-6">
            <h3 class="text-base sm:text-lg font-semibold text-gray-800 mb-4">Form Data</h3>
                    ...
                    <dl class="space-y-3">
                        @foreach($submission->data as $key => $value)
                            <div class="border-b border-gray-200 pb-2">
                                ...
                                <dd class="mt-1 text-sm text-gray-900 break-words">{{ is_array($value) ? json_encode($value) : $value }}</dd>
                            </div>
                        @endforeach
                    </dl>
                @else
