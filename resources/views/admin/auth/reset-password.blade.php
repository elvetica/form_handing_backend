...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white p-6 sm:p-8 rounded-lg shadow-md w-full max-w-md">
        <h1 class="text-xl sm:text-2xl font-bold text-gray-800 mb-6 text-center">Reset Password</h1>
        ...
        <form method="POST" action="{{ route('admin.password.update') }}">
            ...
            <div class="mb-4">
                ...
                <input type="email" id="email" name="email" value="{{ old('email', $email) }}" required readonly
                    class="w-full px-4 py-3 text-base border border-gray-300 rounded-lg bg-gray-100 focus:outline-none"
